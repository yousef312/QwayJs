 ...
 */
function QwayA(duplicates = false) {
  var _this = this;
  ...
  /**
   * QEF or QwayA Escape Function is the rescue function when ever a shortcut was created without it callback.
   * @readonly
   * @type {function}
   */
  this.QEF = function () {};
...
QwayA.prototype = {
   ...
   * @method QwayA#stopGettingFromUser
   */
